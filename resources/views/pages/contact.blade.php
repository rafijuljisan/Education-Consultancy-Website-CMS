...
@section('content')
    ...
    {{-- 
    Wrapper
    - pt-5: Matches your "final" code setting.
    - pb-10: Matches your "final" code setting.
--}}
<div class="w-full bg-white pt-5 pb-10">
    ...
    <div class="max-w-[1400px] mx-auto px-4 md:px-6">
        ...
        <div class="relative w-full bg-gradient-to-r from-[#FF6B35] to-[#FF4B2B] rounded-[30px] overflow-hidden shadow-xl">
            ...
            <div class="relative z-10 py-12 md:py-16 text-center text-white">
                ...
                {{-- Description (From your original Contact code) --}}
    ...
    <div class="max-w-[1400px] mx-auto px-4 py-16 grid md:grid-cols-2 gap-16">
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">123 Education Street,<br>London, UK</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('inquiry.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="message" rows="4"
                        class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary outline-none"></textarea>
                </div>
                <button type="submit"
                    class="w-full bg-primary hover:bg-blue-700 text-white font-bold py-3 rounded-lg transition shadow-lg">
                    Send Message
                </button>
            </form>
        </div>
    ...
    <div class="h-96 bg-gray-200 w-full flex items-center justify-center text-gray-500">
